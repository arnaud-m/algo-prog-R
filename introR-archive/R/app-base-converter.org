...
#+DESCRIPTION: Convertisseur de base
...
* Introduction
  Le but de cette activité est de développer une application web qui convertit un nombre d'une base vers une autre. Les bases doivent sont comprises entre 2 et 36.
  
  - [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html][Shiny Building Interactive Web Applications in R]]. Ian Hansel.
...
** Obtenir le code de l'application
   ...
   Ensuite, téléchargez le fichier [[file:app-base-converter/app-base-converter.R][app-base-converter.R]] contenant le code de l'application, et exécutez le. 
...
* Code source shiny app                                            :noexport:
  ...
  #+BEGIN_SRC R :exports none :noweb yes :tangle app-base-converter/app-base-converter.R 
  <<common>>
  ...
  #+END_SRC
   ...
   #+BEGIN_SRC R :exports none :noweb yes :tangle app-base-converter/app-base-converter-demo.R 
   <<common>>

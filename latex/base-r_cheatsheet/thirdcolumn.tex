...
\begin{block}{Programming}
  ...
  \vskip1ex
  \begin{subblock}{}
    \small\hspace{0.25ex}\begin{beamercolorbox}[ht = 6ex, dp = 6ex, wd = 1.2cm, center, rounded = true]{block title}
      \textbf{\footnotesize Conditions}
    \end{beamercolorbox}
    \hspace{0.5ex}
    \small
    \begin{tableau}{| >{\color{black}}c | >{\color{black}\cellcolor{secondary}}c | >{\color{black}}c | >{\color{black}\centering\cellcolor{secondary}}m{1.15cm} | >{\color{black}}c | >{\color{black}\cellcolor{secondary}\centering\arraybackslash}m{1.85cm} |}% >{\color{black}}c | >{\color{black}\cellcolor{secondary}\centering\arraybackslash}m{0.07\linewidth} |}
      \hline
      \inl{a == b} & Are equal & \inl{a > b} & Greater than & \inl{a >= b} & Greater than or equal to\\\hline
      \inl{a \!=$\ $b} & Not equal & \inl{a < b} & Less than & \inl{a <= b} & Less than or equal to\\\hline
      \inl{is.na(a)} & Is missing & \inl{is.null(a)} & Is null & \multicolumn{2}{c}{} \\\cline{1-4}
      \inl{c || e} & \texttt{c} or \texttt{e} & \inl{c \&\&$\ $y} & \texttt{c} and \texttt{y} & \multicolumn{2}{c}{} \\\cline{1-4}
    \end{tableau}
    \vskip-2ex
  \end{subblock}
\end{block}

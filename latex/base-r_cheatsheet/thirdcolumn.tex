...
\begin{block}{Programming}
  ...
  \begin{subblock}{}
    ...
    \hspace{0.5ex}
    \small
    \begin{tableau}{| >{\color{black}}c | >{\color{black}\cellcolor{secondary}}c | >{\color{black}}c | >{\color{black}\centering\cellcolor{secondary}}m{1.1cm} | >{\color{black}}c | >{\color{black}\cellcolor{secondary}\centering\arraybackslash}m{1.8cm} |}% >{\color{black}}c | >{\color{black}\cellcolor{secondary}\centering\arraybackslash}m{0.07\linewidth} |}
      \hline

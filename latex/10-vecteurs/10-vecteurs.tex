...
\begin{frame}[fragile]
  \frametitle{Évaluation des performances}
    Le protocole expérimental consiste à cacher 2000 mots aléatoires de différentes longueurs avec les trois versions.
  \begin{description}[Version III]

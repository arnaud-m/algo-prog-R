...
** Obtenir le code de l'application
   ...
   Ensuite, téléchargez le fichier [[file:act03-base-converter/app-base-converter.R][app-base-converter.R]] contenant le code de l'application, et exécutez le. 
...
* Code source shiny app                                            :noexport:
  ...
  #+BEGIN_SRC R :exports none :noweb yes :tangle act03-base-converter/app-base-converter.R 
  <<common>>
  ...
  #+END_SRC
   ...
   #+BEGIN_SRC R :exports none :noweb yes :tangle act03-base-converter/app-base-converter-demo.R 
   <<common>>

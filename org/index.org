...
** Licence
 ...
 #+END_EXPORT 
  - [[https://github.com/arnaud-m/algo-prog-R][Code source du site web et des diapositives du cours]].
...
*** Mini-projets
    ...
    |----+---------+--------------------------------------------------+-------+-------------|
    | 1. | TODO    | Graphisme Tortue                                 | [[file:pdf/A1-Tortue.pdf][A1]]    | Tout niveau |
    | 2. | TODO    | Graphisme Tortue 3D                              | A2    | Difficile   |
    | 3. | STARTED | [[file:act03-base-converter.org][Convertisseur de base (shiny)]]                    | [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html#/][A3]]    | Facile      |
    | 4. | TODO    | Coefficient de Gini (shiny)                      | [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html#][A3]]    | Facile      |
    | 5. | TODO    | Estimation de moyenne  (shiny)                   | [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html#/][A3]]    | Facile      |
    | 6. | TODO    | Manipulation de polynômes                        | [[file:pdf/A4-Polynomes.pdf][A4]]    | Difficile   |
    | 7. | TODO    | Estimation d'aires par la méthode de Monte Carlo | A5    | Difficile   |

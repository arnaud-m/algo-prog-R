...
*** Mini-projets
    ...
    | #. | Cours (Partie I)                                 | Ressources | Niveau    |
    |----+--------------------------------------------------+------------+-----------|
    | 1. | Graphisme Tortue                                 |            | Facile    |
    | 2. | Graphisme Tortue 3D                              |            | Difficile |
    | 3. | Convertisseur de base (shiny)                    |            | Facile    |
    | 4. | Coefficient de Gini (shiny)                      |            | Facile    |
    | 5. | Manipulation de polynômes                        |            | Difficile |
    | 6. | Estimation d'aires par la méthode de Monte Carlo |            | Difficile |

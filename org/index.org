...
| 4. | [[file:pdf/06-nombres-approches.pdf][Nombres réels approchés]]  | [[file:pdf/07-calcul-pi.pdf][Approximation du nombre]]                 | [[file:tp04.org][TP 4]]              |
...
| 8. | [[file:pdf/14-fibonacci.pdf][Suite de Fibonacci]]       |                                         | [[file:tp08.org][TP 8]]              |
   ...
   Tous les corrigés des travaux pratiques seront publiés au fur et à mesure.
...
** Activités 
   ...
   Les corrigés des activités ne seront pas publiés.
...
*** STARTED Mini-projets
    ...
    Vous devez déposer le projet sur moodle.

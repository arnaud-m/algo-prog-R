...
** Organisation
 ...
 2. Les évaluations sont sur [[https://lms.univ-cotedazur.frcourse/view.php?id=14555][Moodle]] et [[https://sphere-engine.com/][Sphere Engine]],
 3. Le code source est sur [[https://github.com/arnaud-m/algo-prog-R][github]] !

**** Inscrivez-vous au [[https://lms.univ-cotedazur.fr/course/view.php?id=14555][cours]] sur moodle !
...
*** Exercices UCAnCODE
 ...
 | [[https://51364960.widgets.sphere-engine.com/lp?hash=xQiNQQm3RT][ROULETTE]]          |     12 |
 | [[https://51364960.widgets.sphere-engine.com/lp?hash=bBhh3mP0zF][ADDREV]]            |     12 |
 | [[https://51364960.widgets.sphere-engine.com/lp?hash=29a2Nkat4J][SABLE]]             |     16 |
 | [[https://51364960.widgets.sphere-engine.com/lp?hash=wCIhnuEBms][TRADN]]             |     20 |
 | [[https://51364960.widgets.sphere-engine.com/lp?hash=yM4ZNsKuVX][TRADN0]]            |     20 |
...
** Contrôle continu
   La note de contrôle continu est la moyenne :
     - de la note de partiel, une épreuve écrite de 1h (barème - 7pts / 8pts / 8pts);
     - et des 2 meilleures notes obtenues aux activités.

** Examen terminal
   L'examen terminal est une épreuve écrite de 3h (barème - 3pts / 4pts / 16pts).
...
#+RESULTS:
** Seconde chance
   La seconde chance est une épreuve écrite similaire à l'examen.
   \\
   - Soit $N_1$ votre note finale (première session),
   - et $N_{sc}$ votre note à l'examen de seconde chance.
   - La note de seconde chance est calculée ainsi : $N_2 = \max(N_1, N_{sc})$.


* Communication
Évitez les courriels. Notre mode de communication de prédilection est le *forum sur moodle*.

...
*** Vendredi (SITE)
  ...
  |-------------+----------+-------------+----------|
  | *Groupe 1*  | 215 (AM) | *Groupe 4*  | 314 (SR) |
...
** Autoformation
   ...
   Pour le contrôle continu, elle est évaluée individuellement par des questionnaires sur [[https://lms.univ-cotedazur.fr/course/view.php?id=14552][moodle]] accessible pendant tout le semestre.
...
*** Exercices UCAnCODE
    ...
    Les activités seront publiés ici au fur et à mesure à partir 3 octobre 2019.

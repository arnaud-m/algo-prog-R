...
**** Inscrivez-vous au [[https://lms.unice.fr/course/view.php?id=8151][cours UCAnCODE]] sur moodle !
...
** STARTED Cours 
   Il y a 8 cours, chaun divisé en deux parties, accompagnés de leurs travaux pratiques. 
...
** Activités 
   ...
   Choisissez votre binôme sur [[https://lms.unice.fr/course/view.php?id=8151][moodle]] pour toutes vos activités ! 
...
*** STARTED Mini-projets
    Les mini-projets complètent et étendent des notions abordées en cours et vous font découvrir différentes applications.  
    Vous devez déposer le projet sur moodle et faire une démonstration rapide du projet pendant les travaux pratiques.

    | #. |      | Activité                                         | Cours | Niveau      |
    |----+------+--------------------------------------------------+-------+-------------|
    | 1. | NEXT | [[file:act01.org][Graphisme tortue]]                                 | [[file:pdf/A1-Tortue.pdf][A1]]    | Tout niveau |
    | 2. | TODO | Graphisme tortue 3D                              | A2    | Difficile   |
    | 3. | NEXT | [[file:act03.org][Convertisseur de base (shiny)]]                    | [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html#/][A3]]    | Facile      |
    | 4. | TODO | [[file:act04.org][Coefficient de Gini (shiny)]]                      | [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html#][A3]]    | Facile      |
    | 5. | TODO | [[file:act05.org][Estimation de la moyenne  (shiny)]]                | [[http://www.hanselsolutions.com/blog/surf-talk/shiny-surf.html#/][A3]]    | Facile      |
    | 6. | TODO | [[file:act06.org][Manipulation de polynômes]]                        | [[file:pdf/A4-Polynomes.pdf][A4]]    | Difficile   |
    | 7. | TODO | [[file:act07.org][Estimation d'aires par la méthode de Monte Carlo]] | A5    | Difficile   |
